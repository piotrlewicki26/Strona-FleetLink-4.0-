...
<head>
    ...
    <meta name="description" content="FleetLink 4.0 dla branży budowa: monitoring GPS, raportowanie i zarządzanie flotą dopasowane do specyfiki operacyjnej." />
    <meta name="robots" content="index, follow" />
    <title>Budowa | FleetLink 4.0</title>
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://fleetlink.pl/branze/budowa" />
    <meta property="og:title" content="Budowa | FleetLink 4.0" />
    <meta property="og:description" content="Poznaj rozwiązania FleetLink dla branży budowa." />
    <meta property="og:image" content="https://fleetlink.pl/assets/img/og-image.jpg" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Budowa | FleetLink 4.0" />
    <meta name="twitter:description" content="Poznaj rozwiązania FleetLink dla branży budowa." />
    <link rel="canonical" href="https://fleetlink.pl/branze/budowa" />
...
<main class="industry-page-main">
    <section class="section industry-hero industry-hero-hub">
        ...
        <div class="section-inner industry-hero-inner">
            <div class="industry-breadcrumbs"><a href="/">Strona główna</a> <span>›</span> <a href="/branze">Wszystkie branże</a> <span>›</span> Budowa</div>
            <span class="section-tag">Budowa</span>
            <h1>Monitoring GPS dla budowy</h1>
            <p>Nadzór nad sprzętem, zespołami i aktywnością na placach budowy.</p>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            ...
            <article class="industry-case-box fade-in">
                <p>Klient z branży budowa wdrożył FleetLink 4.0, by poprawić planowanie działań terenowych i podnieść efektywność operacyjną.</p>
    ...
    <section class="section" id="cta">
        <div class="section-inner">
            <div class="industry-page-cta fade-up">
                <h2>Porozmawiajmy o wdrożeniu dla branży budowa</h2>
