...
<main class="industry-page-main">
    <section class="section industry-hero industry-hero-hub">
        ...
        <div class="section-inner industry-hero-inner">
            <div class="industry-breadcrumbs"><a href="/">Strona główna</a> <span>›</span> <a href="/branze">Wszystkie branże</a> <span>›</span> Gospodarka odpadami</div>
            <span class="section-tag">Gospodarka odpadami</span>
            <h1>System GPS dla gospodarki odpadami</h1>
            <p>Planowanie odbiorów, kontrola harmonogramów i monitoring tras serwisowych.</p>
    ...
    <section class="section" id="cta">
        <div class="section-inner">
            <div class="industry-page-cta fade-up">
                <h2>Porozmawiajmy o wdrożeniu dla branży gospodarka odpadami</h2>
