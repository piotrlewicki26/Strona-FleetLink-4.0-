...
<main class="industry-page-main">
    <section class="section industry-hero industry-hero-hub">
        ...
        <div class="section-inner industry-hero-inner">
            <div class="industry-breadcrumbs"><a href="/">Strona główna</a> <span>›</span> <a href="/branze">Wszystkie branże</a> <span>›</span> Transport pasażerski</div>
            <span class="section-tag">Transport pasażerski</span>
            <h1>Monitoring GPS dla transportu pasażerskiego</h1>
            <p>Kontrola punktualności przejazdów i jakości obsługi pasażerów.</p>
    ...
    <section class="section" id="cta">
        <div class="section-inner">
            <div class="industry-page-cta fade-up">
                <h2>Porozmawiajmy o wdrożeniu dla branży transport pasażerski</h2>
