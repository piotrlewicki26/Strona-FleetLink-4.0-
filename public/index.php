...
<section class="section" id="industries">
    <div class="section-inner">
        <div class="section-head fade-up">
            ...
            <h2>Branże <span class="gradient-text">extra premium</span></h2>
            <p>Skupiamy się na 3 kluczowych branżach. Najedź na kafelek, aby zobaczyć dedykowane korzyści i scenariusze wdrożeń.</p>
        </div>
        <div class="industries-grid">
            <article class="industry-premium-card fade-in ind-transport">
                <div class="industry-premium-bg" aria-hidden="true"></div>
                <div class="industry-premium-front">
                    <span class="industry-premium-kicker">Transport</span>
                    <h4>Transport i logistyka</h4>
                    <p>Nowoczesny monitoring floty ciężkiej i pełna kontrola nad łańcuchem dostaw.</p>
                </div>
                <div class="industry-premium-back">
                    <span class="industry-premium-kicker">Transport i logistyka</span>
                    <h4>Precyzja operacyjna 24/7</h4>
                    <p>Optymalizacja tras, monitoring czasu pracy kierowców i automatyzacja raportowania.</p>
                    <ul class="industry-premium-points">
                        <li>Planowanie i rozliczanie kursów</li>
                        <li>Integracja z WMS/ERP</li>
                    </ul>
                    <a href="/branze/transport-i-logistyka" class="industry-premium-link">Zobacz branżę</a>
                </div>
            </article>
            <article class="industry-premium-card fade-in ind-courier">
                <div class="industry-premium-bg" aria-hidden="true"></div>
                <div class="industry-premium-front">
                    <span class="industry-premium-kicker">Dostawy</span>
                    <h4>Kurierzy i dostawy</h4>
                    <p>Pełna widoczność tras last mile i statusów doręczeń w czasie rzeczywistym.</p>
                </div>
                <div class="industry-premium-back">
                    <span class="industry-premium-kicker">Kurierzy i dostawy</span>
                    <h4>Szybkość i punktualność</h4>
                    <p>FleetLink skraca czas realizacji i podnosi jakość obsługi klienta końcowego.</p>
                    <ul class="industry-premium-points">
                        <li>Optymalizacja tras kurierów</li>
                        <li>Śledzenie realizacji dostaw live</li>
                    </ul>
                    <a href="/branze/kurierzy-i-dostawy" class="industry-premium-link">Zobacz branżę</a>
                </div>
            </article>
            <article class="industry-premium-card fade-in ind-build">
                <div class="industry-premium-bg" aria-hidden="true"></div>
                <div class="industry-premium-front">
                    <span class="industry-premium-kicker">Budownictwo</span>
                    <h4>Budownictwo</h4>
                    <p>Monitoring maszyn i ekip terenowych na wielu placach budów jednocześnie.</p>
                </div>
                <div class="industry-premium-back">
                    <span class="industry-premium-kicker">Budownictwo</span>
                    <h4>Kontrola sprzętu i godzin pracy</h4>
                    <p>System wspiera geofencing stref roboczych i raporty aktywności ciężkiego sprzętu.</p>
                    <ul class="industry-premium-points">
                        <li>Maszyny budowlane i auta serwisowe</li>
                        <li>Historia pracy na obiektach</li>
                    </ul>
                    <a href="/branze/budownictwo" class="industry-premium-link">Zobacz branżę</a>
                </div>
            </article>
        </div>
