...
<main class="industry-page-main premium-route-page">
    <section class="section industry-hero industry-hero-hub">
        ...
        <div class="section-inner industry-hero-inner">
            ...
            <div class="badge pulse"><span class="badge-dot"></span> Współdzielenie pojazdów 24/7</div>
            <h1>CarSharing</h1>
            <p>Rozwiązanie, które pozwala wygodnie dzielić się pojazdami między pracownikami.</p>
    ...
    <div class="stats-bar">
        <div class="stats-inner">
            <div class="stat-item">
                ...
                <span class="stat-label">widoczność dostępności pojazdów</span>
            </div>
            <div class="stat-divider" aria-hidden="true"></div>
            <div class="stat-item">
                <div class="stat-num-row"><strong>100</strong><span>%</span></div>
                <span class="stat-label">przejrzystość rezerwacji dla zespołu</span>
            </div>
            <div class="stat-divider" aria-hidden="true"></div>
            <div class="stat-item">
                <div class="stat-num-row"><strong>↓30</strong><span>%</span></div>
                <span class="stat-label">mniej czasu na ręczną koordynację aut</span>
            </div>
            <div class="stat-divider" aria-hidden="true"></div>
            <div class="stat-item">
                <div class="stat-num-row"><strong>1</strong><span>moduł</span></div>
                <span class="stat-label">carsharing, lokalizacja i rezerwacje</span>
            </div>
        </div>
    </div>
    ...
    <section class="section">
        <div class="section-inner">
            <div class="section-head fade-up">
                ...
                <h2>Łatwe udostępnianie pojazdów</h2>
                <p>Pracownicy widzą, które pojazdy są zajęte lub zarezerwowane do użytku, a Ty masz pełną kontrolę nad wykorzystaniem floty.</p>
            </div>
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>🚘 Dostępność w czasie rzeczywistym</h3><p>Pracownicy widzą, które pojazdy są zajęte lub zarezerwowane do użytku.</p></article>
                <article class="industry-info-card fade-in"><h3>⚙️ Priorytetyzacja wykorzystania aut</h3><p>Pojazdy są traktowane priorytetowo na podstawie wybranych ustawień przebiegu.</p></article>
                <article class="industry-info-card fade-in"><h3>📍 Lokalizacja całej floty</h3><p>Zobacz aktualną lokalizację całej Twojej floty.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            <div class="section-head fade-up">
                ...
                <h2>Dodaj tu swój tekst nagłówka</h2>
                <p>Sprawdzaj realne obciążenie pojazdów i podejmuj decyzje oparte na danych, nie na domysłach.</p>
            </div>
            <div class="industry-benefits-grid">
                <article class="industry-benefit-card fade-in"><strong>📊 Analiza wykorzystania floty</strong><span>Określ, czy Twoje pojazdy są używane zbyt często lub zbyt rzadko, korzystając z danych o przebiegu.</span></article>
                <article class="industry-benefit-card fade-in"><strong>⚖️ Porównanie obciążenia pojazdów</strong><span>Sprawdź, czy niektóre pojazdy są używane bardziej niż inne.</span></article>
                <article class="industry-benefit-card fade-in"><strong>🧩 Lepsza alokacja zasobów</strong><span>Popraw alokację zasobów, dostosowując wielkość swojej floty.</span></article>
            </div>
            <p class="industry-keywords industry-keywords-center">Zarządzanie flotą, LeMar GPS System, Monitoring pojazdów, zarządzanie kierowcami, Lokalizacja pojazdów, śledzenie zasobów, formularze, czas pracy, e-toll, Inspekcje pojazdów, blokada alkoholowa</p>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-inner">
            <div class="section-head fade-up">
                ...
                <h2>Najważniejsze elementy modułu CarSharing</h2>
                <p>Rezerwacje, lokalizacja i kontrola użycia pojazdów w jednym środowisku pracy.</p>
            </div>
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>📱 Rezerwacje z aplikacji</h3><p>Skorzystaj z rozwiązania w aplikacji LeMar Drive i rezerwuj pojazdy, gdziekolwiek jesteś.</p></article>
                <article class="industry-info-card fade-in"><h3>🔁 Dynamiczna dostępność pojazdów</h3><p>Zespół natychmiast widzi status pojazdów i może planować pracę bez konfliktów rezerwacji.</p></article>
                <article class="industry-info-card fade-in"><h3>🔒 Kontrola dostępu</h3><p>Nasza integracja API pozwala Ci blokować i odblokowywać pojazd oraz sprawdzać jego lokalizację.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            <div class="section-head fade-up">
                ...
                <h2>Rezerwuj pojazdy z aplikacji</h2>
            </div>
            <article class="industry-case-box fade-in">
                <p><strong>LeMar GO:</strong> Skorzystaj z rozwiązania w aplikacji LeMar Drive i rezerwuj pojazdy, gdziekolwiek jesteś.</p>
                <ul class="industry-case-points">
                    <li>✅ Błyskawiczna rezerwacja pojazdu przez pracownika</li>
                    <li>✅ Pełna widoczność zajętości i dostępności aut</li>
                    <li>✅ Mniej konfliktów i przestojów w codziennym użytkowaniu floty</li>
                    <li>✅ Prostsza koordynacja pracy zespołów terenowych</li>
                </ul>
            </article>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-inner">
            <div class="section-head fade-up">
                ...
                <h2>Użyj rozwiązania w swoim systemie lub aplikacji</h2>
                <p>Nasza integracja API pozwala Ci blokować i odblokowywać pojazd oraz sprawdzać jego lokalizację z systemów lub aplikacji mobilnych używanych przez Twoją firmę.</p>
            </div>
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>🔗 Integracja API</h3><p>Podłącz CarSharing do systemów firmowych i automatyzuj obieg informacji o pojazdach.</p></article>
                <article class="industry-info-card fade-in"><h3>🛰️ Lokalizacja pojazdu</h3><p>Sprawdzaj pozycję pojazdu bezpośrednio z narzędzi, których Twój zespół używa na co dzień.</p></article>
                <article class="industry-info-card fade-in"><h3>🔐 Zdalna blokada i odblokowanie</h3><p>Zarządzaj dostępem do pojazdu z poziomu procesów i aplikacji wewnętrznych.</p></article>
                <article class="industry-info-card fade-in"><h3>📦 Skalowanie procesu</h3><p>Rozwijaj współdzielenie pojazdów w całej organizacji bez zwiększania pracy ręcznej.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            <div class="section-head fade-up">
                ...
                <h2>3 powody, dla których firmy wdrażają CarSharing</h2>
            </div>
            <div class="industry-benefits-grid">
                <article class="industry-benefit-card fade-in"><strong>🧠 Lepsze wykorzystanie zasobów</strong><span>Każdy pojazd pracuje wtedy, gdy jest potrzebny, a nie stoi bez użycia.</span></article>
                <article class="industry-benefit-card fade-in"><strong>💰 Mniejsze koszty floty</strong><span>Optymalizacja wykorzystania pojazdów pomaga ograniczyć niepotrzebne wydatki inwestycyjne i operacyjne.</span></article>
                <article class="industry-benefit-card fade-in"><strong>🚀 Sprawniejsza organizacja pracy</strong><span>Przejrzyste zasady rezerwacji i dostępności skracają czas koordynacji między pracownikami.</span></article>
            </div>
        </div>
    </section>
    ...
    <section class="section" id="cta">
        <div class="section-inner">
            <div class="industry-page-cta fade-up">
                ...
                <h2>Wdróż CarSharing i uporządkuj dostęp do pojazdów w firmie</h2>
                <p>Pokażemy Ci, jak dopasować moduł CarSharing do procesów Twojej floty i zespołów, które z niej korzystają każdego dnia.</p>
                <div class="hero-actions">
                    <a href="/#contact" class="btn btn-primary btn-lg">Skontaktuj się</a>
                    <a href="/system-gps/integracje" class="btn btn-ghost btn-lg">Poznaj integracje</a>
                </div>
