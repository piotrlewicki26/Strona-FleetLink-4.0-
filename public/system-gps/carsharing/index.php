...
<main class="industry-page-main premium-route-page">
    <section class="section industry-hero industry-hero-hub">
        ...
        <div class="section-inner industry-hero-inner">
            ...
            <div class="stats-bar fade-up">
                <div class="stat-item">
                    <strong>24/7</strong>
                    <span class="stat-label">wgląd w dostępność pojazdów</span>
                </div>
                <div class="stat-divider" aria-hidden="true"></div>
                <div class="stat-item">
                    <strong>100%</strong>
                    <span class="stat-label">przejrzystość rezerwacji</span>
                </div>
                <div class="stat-divider" aria-hidden="true"></div>
                <div class="stat-item">
                    <strong>1</strong>
                    <span class="stat-label">system do współdzielenia floty</span>
                </div>
            </div>
            <p class="industry-keywords industry-keywords-center">Zarządzanie flotą, LeMar GPS System, Monitoring pojazdów, zarządzanie kierowcami, Lokalizacja pojazdów, śledzenie zasobów, formularze, czas pracy, e-toll, Inspekcje pojazdów, blokada alkoholowa, CarSharing</p>
    ...
    <section class="section">
        <div class="section-inner">
            ...
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>Wolne i zajęte pojazdy</h3><p>Pracownicy widzą, które pojazdy są zajęte lub zarezerwowane do użytku.</p></article>
                <article class="industry-info-card fade-in"><h3>Priorytety przebiegu</h3><p>Pojazdy są traktowane priorytetowo na podstawie wybranych ustawień przebiegu.</p></article>
                <article class="industry-info-card fade-in"><h3>Lokalizacja floty</h3><p>Zobacz aktualną lokalizację całej Twojej floty.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            <div class="section-head fade-up">
                <span class="section-tag">Wykorzystanie floty</span>
                <h2>Dodaj tu swój tekst nagłówka</h2>
            </div>
            <div class="industry-benefits-grid">
                <article class="industry-benefit-card fade-in"><strong>Analiza użycia pojazdów</strong><span>Określ, czy Twoje pojazdy są używane zbyt często lub zbyt rzadko, korzystając z danych o przebiegu.</span></article>
                <article class="industry-benefit-card fade-in"><strong>Porównanie obciążenia</strong><span>Sprawdź, czy niektóre pojazdy są używane bardziej niż inne.</span></article>
    ...
    <section class="section">
        <div class="section-inner">
            <div class="section-head fade-up">
                <span class="section-tag">Aplikacja</span>
                <h2>Rezerwuj pojazdy z aplikacji</h2>
            </div>
            <article class="industry-case-box fade-in">
                <h3>LeMar GO</h3>
                <p>Skorzystaj z rozwiązania w aplikacji LeMar Drive i rezerwuj pojazdy, gdziekolwiek jesteś.</p>
            </article>
        </div>
    </section>
