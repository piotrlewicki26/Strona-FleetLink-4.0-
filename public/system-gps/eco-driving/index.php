...
<main class="industry-page-main">
    ...
    <section class="section">
        <div class="section-inner">
            ...
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>Brak obiektywnej oceny</h3><p>Ocena kierowców bez danych telemetrycznych jest niepełna i często zbyt późna.</p></article>
                <article class="industry-info-card fade-in"><h3>Wyższe spalanie</h3><p>Agresywna jazda bezpośrednio przekłada się na koszty paliwa i serwisu.</p></article>
                <article class="industry-info-card fade-in"><h3>Większe ryzyko zdarzeń</h3><p>Nagłe przyspieszenia i hamowania obniżają bezpieczeństwo pracy floty.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            ...
            <div class="industry-benefits-grid">
                <article class="industry-benefit-card fade-in"><strong>Niższe spalanie</strong><span>Lepsze nawyki kierowców zmniejszają koszty przejazdów.</span></article>
                <article class="industry-benefit-card fade-in"><strong>Bezpieczniejsza jazda</strong><span>Zespół szybciej eliminuje ryzykowne zachowania na trasie.</span></article>
                <article class="industry-benefit-card fade-in"><strong>Motywacja do poprawy</strong><span>Czytelne wyniki ułatwiają wdrożenie standardów jazdy.</span></article>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-inner">
            ...
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>Scoring kierowców</h3><p>Porównujesz styl jazdy w czytelnym rankingu kierowców.</p></article>
                <article class="industry-info-card fade-in"><h3>Historia zdarzeń</h3><p>Masz podgląd gwałtownych manewrów i trendów w czasie.</p></article>
                <article class="industry-info-card fade-in"><h3>Raporty szkoleniowe</h3><p>Wybierasz kierowców wymagających wsparcia lub dodatkowego coachingu.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            ...
            <article class="industry-case-box fade-in">
                <p>Manager floty wdraża cykliczny przegląd wyników ECO-DRIVING i widzi poprawę spalania już po pierwszych tygodniach pracy z rankingami.</p>
                <ul class="industry-case-points">
                    <li>Ranking kierowców według stylu jazdy</li>
                    <li>Monitoring nagłych zdarzeń</li>
                    <li>Podstawa do programów premiowych</li>
                </ul>
            </article>
        </div>
    </section>
