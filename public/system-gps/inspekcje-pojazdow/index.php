...
<head>
    ...
    <meta name="description" content="Inspekcje pojazdów w FleetLink 4.0: checklisty, zgłoszenia usterek i kontrola gotowości floty." />
    <meta name="robots" content="index, follow" />
    <title>Inspekcje pojazdów | FleetLink 4.0</title>
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://fleetlink.pl/system-gps/inspekcje-pojazdow" />
    <meta property="og:title" content="Inspekcje pojazdów | FleetLink 4.0" />
    <meta property="og:description" content="Sprawdź, jak cyfrowe inspekcje pojazdów pomagają utrzymać flotę w gotowości." />
    <meta property="og:image" content="https://fleetlink.pl/assets/img/og-image.jpg" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Inspekcje pojazdów | FleetLink 4.0" />
    <meta name="twitter:description" content="Sprawdź, jak cyfrowe inspekcje pojazdów pomagają utrzymać flotę w gotowości." />
    <link rel="canonical" href="https://fleetlink.pl/system-gps/inspekcje-pojazdow" />
...
<main class="industry-page-main">
    <section class="section industry-hero industry-hero-hub">
        ...
        <div class="section-inner industry-hero-inner">
            <div class="industry-breadcrumbs"><a href="/">Strona główna</a> <span>›</span> <a href="/system-gps">System GPS</a> <span>›</span> Inspekcje pojazdów</div>
            <span class="section-tag">Automatyzacja procesów</span>
            <h1>Wykonuj inspekcje pojazdów szybciej i z pełną historią usterek</h1>
            <p>Digitalizuj checklisty stanu technicznego, zgłoszenia uszkodzeń i potwierdzenia gotowości pojazdów do pracy.</p>
    ...
    <section class="section">
        <div class="section-inner">
            ...
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>Papierowe checklisty</h3><p>Ręczne formularze trudno archiwizować i analizować w czasie.</p></article>
                <article class="industry-info-card fade-in"><h3>Opóźnione zgłoszenia usterek</h3><p>Problem techniczny trafia do serwisu zbyt późno lub bez pełnego kontekstu.</p></article>
                <article class="industry-info-card fade-in"><h3>Brak historii przeglądów</h3><p>Trudno sprawdzić, kiedy i przez kogo wykonano kontrolę pojazdu.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            ...
            <div class="industry-benefits-grid">
                <article class="industry-benefit-card fade-in"><strong>Wyższa gotowość floty</strong><span>Usterki są wykrywane wcześniej, zanim przełożą się na przestój.</span></article>
                <article class="industry-benefit-card fade-in"><strong>Lepsza dokumentacja</strong><span>Każda kontrola pozostawia czytelny ślad w systemie.</span></article>
                <article class="industry-benefit-card fade-in"><strong>Sprawniejsze działania serwisowe</strong><span>Zespół techniczny dostaje uporządkowane zgłoszenia.</span></article>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-inner">
            ...
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>Checklisty przed wyjazdem</h3><p>Kierowcy lub brygady potwierdzają stan pojazdu przed rozpoczęciem pracy.</p></article>
                <article class="industry-info-card fade-in"><h3>Zgłoszenia usterek</h3><p>Problemy trafiają do odpowiedzialnych osób z odpowiednim opisem.</p></article>
                <article class="industry-info-card fade-in"><h3>Historia kontroli</h3><p>Masz pełny podgląd przeglądów i działań naprawczych.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            ...
            <article class="industry-case-box fade-in">
                <p>Pracownik terenowy zgłasza uszkodzenie podczas porannej inspekcji, a serwis planuje naprawę jeszcze przed wyjazdem kolejnej zmiany.</p>
                <ul class="industry-case-points">
                    <li>Mniej awarii w trasie</li>
                    <li>Czytelna historia stanu technicznego</li>
                    <li>Szybsze przekazywanie zgłoszeń do serwisu</li>
                </ul>
            </article>
        </div>
    </section>
    ...
    <section class="section" id="cta">
        <div class="section-inner">
            <div class="industry-page-cta fade-up">
                <h2>Porozmawiajmy o wdrożeniu modułu Inspekcje pojazdów</h2>
