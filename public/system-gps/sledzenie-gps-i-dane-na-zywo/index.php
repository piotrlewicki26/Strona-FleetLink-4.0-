...
<main class="industry-page-main">
    <section class="section industry-hero industry-hero-hub">
        ...
        <div class="section-inner industry-hero-inner">
            ...
            <h1>Zobacz flotę na żywo i reaguj bez opóźnień</h1>
            <p>Aktualna lokalizacja, statusy i historia przejazdów pomagają szybciej zarządzać ruchem, obsługą klienta i bezpieczeństwem.</p>
    ...
    <section class="section">
        <div class="section-inner">
            ...
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>Brak aktualnego obrazu sytuacji</h3><p>Bez danych live trudno podejmować szybkie decyzje operacyjne.</p></article>
                <article class="industry-info-card fade-in"><h3>Opóźniona komunikacja z klientem</h3><p>Zespół nie ma pewności, gdzie znajduje się pojazd i kiedy dotrze.</p></article>
                <article class="industry-info-card fade-in"><h3>Utrudnione reagowanie</h3><p>Awaria, postój lub zmiana trasy bywają widoczne zbyt późno.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            ...
            <div class="industry-benefits-grid">
                <article class="industry-benefit-card fade-in"><strong>Pełna widoczność floty</strong><span>W każdej chwili wiesz, gdzie są pojazdy i co robią.</span></article>
                <article class="industry-benefit-card fade-in"><strong>Lepsza obsługa klienta</strong><span>Łatwiej przekazujesz precyzyjne informacje o statusie realizacji.</span></article>
                <article class="industry-benefit-card fade-in"><strong>Szybsze decyzje</strong><span>Dyspozytor reaguje na zdarzenia natychmiast po ich wystąpieniu.</span></article>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-inner">
            ...
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>Mapa live</h3><p>Bieżąca lokalizacja i ruch pojazdów w jednym widoku.</p></article>
                <article class="industry-info-card fade-in"><h3>Statusy operacyjne</h3><p>Podgląd postoju, jazdy, pracy lub realizacji zadania.</p></article>
                <article class="industry-info-card fade-in"><h3>Historia tras</h3><p>Analiza przebytych odcinków i czasu realizacji.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            ...
            <article class="industry-case-box fade-in">
                <p>Dział obsługi klienta potwierdza czas dojazdu na podstawie danych live zamiast kontaktować się każdorazowo z kierowcą.</p>
                <ul class="industry-case-points">
                    <li>Aktualna lokalizacja floty</li>
                    <li>Szybsza reakcja na zdarzenia</li>
                    <li>Lepsza informacja dla klientów i operacji</li>
                </ul>
            </article>
        </div>
    </section>
    ...
    <section class="section" id="cta">
        <div class="section-inner">
            <div class="industry-page-cta fade-up">
                <h2>Porozmawiajmy o wdrożeniu modułu Śledzenie GPS i dane na żywo</h2>
