...
<head>
    ...
    <meta name="description" content="Zarządzanie flotą w FleetLink: pełny obraz pojazdów, kierowców, kosztów i działań operacyjnych." />
    <meta name="robots" content="index, follow" />
    <title>Zarządzanie flotą | FleetLink</title>
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://fleetlink.pl/system-gps/zarzadzanie-flota" />
    <meta property="og:title" content="Zarządzanie flotą | FleetLink" />
    ...
    <meta name="twitter:title" content="Zarządzanie flotą | FleetLink" />
    ...
    <section class="section" id="cta">
        <div class="section-inner">
            <div class="industry-page-cta fade-up">
                ...
                <p>Skonfigurujemy FleetLink tak, aby Twój zespół miał automatyczny nadzór nad serwisem, dokumentami, kosztami i wydajnością pojazdów.</p>
                <div class="hero-actions">
                    <a href="/#contact" class="btn btn-primary btn-lg">Umów bezpłatną konsultację</a>
                    <a href="/system-gps" class="btn btn-ghost btn-lg">Zobacz wszystkie funkcje</a>
                </div>
