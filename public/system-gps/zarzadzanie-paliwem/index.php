...
<main class="industry-page-main">
    ...
    <section class="section">
        <div class="section-inner">
            ...
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>Nieprzewidywalne koszty</h3><p>Trudno szybko ustalić, które pojazdy lub trasy generują najwyższe spalanie.</p></article>
                <article class="industry-info-card fade-in"><h3>Brak spójnych danych</h3><p>Informacje o tankowaniach, trasach i pracy kierowców są rozproszone między różnymi źródłami.</p></article>
                <article class="industry-info-card fade-in"><h3>Ryzyko nadużyć</h3><p>Bez bieżącej kontroli łatwo przeoczyć nieuzasadnione różnice w zużyciu paliwa.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            ...
            <div class="industry-benefits-grid">
                <article class="industry-benefit-card fade-in"><strong>Niższe koszty paliwa</strong><span>Szybko identyfikujesz obszary wymagające korekty.</span></article>
                <article class="industry-benefit-card fade-in"><strong>Lepsze decyzje</strong><span>Masz aktualne dane do rozmów z kierowcami i planistami.</span></article>
                <article class="industry-benefit-card fade-in"><strong>Większa przejrzystość</strong><span>Każde tankowanie i spalanie jest widoczne w jednym panelu.</span></article>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-inner">
            ...
            <div class="industry-content-grid">
                <article class="industry-info-card fade-in"><h3>Raporty zużycia</h3><p>Zestawienia spalania według pojazdu, kierowcy lub odcinka trasy.</p></article>
                <article class="industry-info-card fade-in"><h3>Powiązanie z lokalizacją</h3><p>Łączysz tankowanie z przejazdem, godziną i miejscem zdarzenia.</p></article>
                <article class="industry-info-card fade-in"><h3>Alerty odchyleń</h3><p>Dostajesz sygnał, gdy zużycie paliwa odbiega od przyjętych norm.</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="section section-soft">
        <div class="section-inner">
            ...
            <article class="industry-case-box fade-in">
                <p>Dyspozytor widzi wzrost spalania w wybranej grupie aut, porównuje styl jazdy i trasę, a następnie wdraża korekty jeszcze tego samego dnia.</p>
                <ul class="industry-case-points">
                    <li>Porównanie zużycia między pojazdami</li>
                    <li>Szybkie wychwycenie nietypowych tankowań</li>
                    <li>Stały monitoring kosztów paliwowych</li>
                </ul>
            </article>
        </div>
    </section>
